...
export function PuzzleReview({ attempt, rating, onPreview, actions, blocked = false, showEvaluation = true }: { attempt: Attempt; rating?: number; onPreview: (frame: PuzzleFrame | null) => void; actions?: ReactNode; blocked?: boolean; showEvaluation?: boolean }) {
