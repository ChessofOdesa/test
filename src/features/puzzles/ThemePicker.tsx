    ...
    return <section className="puzzle-theme-picker">
        ...
        <Dialog open={open} onOpenChange={changeOpen}>
            ...
            <DialogContent closeLabel="Закрити" className="puzzle-theme-dialog">
                ...
                <label className="puzzle-theme-search"><Search size={18} /><input autoFocus aria-label="Пошук теми" placeholder="Пошук теми…" value={query} onChange={e => setQuery(e.target.value)} /></label>
