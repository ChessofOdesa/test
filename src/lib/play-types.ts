...
export type PlayCapabilities = { protocol: number; customTime: boolean; casual: boolean; challenges: boolean; ratingRange: boolean; rated: boolean; ratedTimeControls: string[] | "all"; tournaments: boolean; chess960: boolean };
